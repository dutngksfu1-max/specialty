...
const resultProfiles = Array.from({ length: 2 ** AXIS_IDS.length }, (_, mask) => {
  ...
  return {
    ...
    rhythm: `[fixture] ${key}`,
    shiningMoments: [{ scene: "[fixture]", situation: "[fixture]", text: `[fixture] ${key}` }],
    underPressure: [{ scene: "[fixture]", situation: "[fixture]", text: `[fixture] ${key}` }],
    withColleagues: [{ scene: "[fixture]", situation: "[fixture]", text: `[fixture] ${key}` }],
